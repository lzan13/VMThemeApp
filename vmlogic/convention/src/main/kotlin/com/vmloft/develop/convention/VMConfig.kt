 ...
 */
object VMConfig {
    const val applicationId = "com.vmloft.develop.app"
    ...
    // BuildFeatures 配置
    const val isBuildConfig = false // 是否启用 BuildConfig Gradle 8.x 默认关闭了 9.0将移除
...
//    const val imHostDebug = "\"ws://192.168.31.107:5920/\""
